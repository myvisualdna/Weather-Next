...
export const Altiumdesigner: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AltiumdesignerDimensions = {height: 24, width: 24}
