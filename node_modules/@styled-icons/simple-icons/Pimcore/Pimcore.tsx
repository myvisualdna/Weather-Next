...
export const Pimcore: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PimcoreDimensions = {height: 24, width: 24}
